...
<div class="gettingstarted">
  ...
  {:else}
    <p>
      To get started, you should first choose a directory to save your data in <a href="#/settings">Settings</a>. After
      that, you can add books manually or by search.
    </p>
  {/if}
  <h3>API Keys</h3>
  <p>
    By default, search uses the <a href="https://openlibrary.org/" target="_blank">OpenLibrary</a> API. If you add an
    <a href="https://developers.google.com/books/docs/v1/using#APIKey" target="_blank">API key for Google Books</a> via
  ...
  <p>
    As the Google Cloud APIs have a potential cost (albeit a small one), this functionality is not enabled by default in
    order to keep the app free.
  </p>
  <h3>More Info</h3>
  <p>
    You can find more information on the <a href="https://github.com/reiniiriarios/book-tracker#readme" target="_blank"
      >GitHub Repo</a
    > for this app.
  </p>
</div>
