...
export const config: Options.Testrunner = {
  ...
  //
  specs: [
    "./test/specs/page.*.test.ts",
    ["./test/specs/edit.book.test.ts", "./test/specs/add.book.test.ts"],
    ["./test/specs/edit.settings.test.ts"],
  ],
  // Patterns to exclude.
  exclude: [
  ...
  suites: {
    ...
    settings: ["./test/specs/edit.settings.test.ts"],
  },
  //
  // ============
  // Capabilities
  ...
  beforeSession: function (config, capabilities, specs, cid) {
    // Silences bug "Most NODE_OPTIONs are not supported in packaged apps."
